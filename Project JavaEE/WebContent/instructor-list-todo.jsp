...
<body>
	<div class="container">
		<form class="form-login" action="RegisterControllerServlet"
			...
			<div class="form-footer-copyright">Login Success - Instructor</div>
			<td>Welcome</td>
			<tr>
			...
			<div id="content">
				...
				<table>
					...
					<c:forEach var="tempTodo" items="${TODO_LIST}">
						...
						<c:url var="DelLink" value="DeleteToDo">
							<c:param name="todoId" value="${tempTodo.id}" />
						</c:url>
						<tr>
		...
		<form class="form-login" action="AddToDo" method="get"
			id="formWrapper">
			<div id="container">
				<div class="row-fluid">
					<input type="submit" value="Add ToDo" id="btn_AddToDo"
						class="btn btn-primary pull-right span6" />
				</div>
			</div>
		</form>
		...
		<div class="form-footer-copyright">
			ALV Online - <small>2019 © Léonard de Vinci</small> <small>Dynamic
				Web Application</small><br> Xavier BOUVET - Johny LIN<br> <small>
				ESILV A4 IBO 2</small>
		</div>
		<!-- END FOOTER -->
	</div>
</body>
